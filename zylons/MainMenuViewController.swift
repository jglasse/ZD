...
class MainMenuViewController: UIViewController, AVAudioPlayerDelegate {
    ...
    var currentCredit = 0
    let credits = ["based on STAR RAIDERS by Doug Neubauer", "Music by Neon Insect", "Special thanks to Lorenz Wiest", "Programmed and designed by Jeff Glasse", "With many thanks to Aimee for her infinite patience", "Copyright 2026 Nine Industries. All Rights Reserved."]
